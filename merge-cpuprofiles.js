...
fs
    ...
    .forEach(fn => {
        ...
        console.log(`${fn}: ${p.samples.length} samples, ${p.timeDeltas.length} deltas, ${p.endTime - p.startTime} time delta`);
...
console.log(`Saved ${resultFilename} with ${profile.samples.length} samples, ${profile.timeDeltas.length} deltas, ${profile.endTime - profile.startTime} time delta`);
